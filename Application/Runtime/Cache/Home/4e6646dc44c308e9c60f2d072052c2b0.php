                ...
                <table border="1" style="margin: auto;">
                    ...
                    <tr> 
                        <th colspan="6" align="center">使用部门 &nbsp;
                            <select name="use_department_id" id="test">
                                ...
                                <?php if(is_array($department_data)): $i = 0; $__LIST__ = $department_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option option_id="<?php echo ($vo['id']); ?>" value="<?php echo ($vo['id']); ?>"><?php echo ($vo['department_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="6" align="center">考核类型 &nbsp;
                            ...
                            <input type="button" value="请选择填写人" class="fill_in_user" />
                        </th>
                    </tr>
                    <tr>
                        <th colspan="6" align="center">业绩考核</th>
                    </tr>
                    <tr>
                        <th rowspan="3">
                                考核项目
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center">
                            <input type="text" name="assessment_name_one" id="assessment_name_one" value="" />
                        </td>
                        <td align="center"><input type="text" name="score_one" id="score_one" value="" /></td>
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_two" id="assessment_name_two" value="" /></td>
                        <td align="center"><input type="text" name="score_two" id="score_two" value="" /></td>
                        <td width="200px" align="center">
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_three" id="assessment_name_three" value="" /></td>
                        <td align="center"><input type="text" name="score_three" id="score_three" value="" /></td>
                        <td width="200px" align="center">
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_four" id="assessment_name_four" value="" /></td>
                        <td align="center"><input type="text" name="score_four" id="score_four" value="" /></td>
                        <td width="200px" align="center">
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_one_xw" id="assessment_name_one_xw" value="" /></td>
                        <td align="center"><input type="text" name="score_one_xw" id="score_one_xw" value="" /></td>
                        <td width="200px" align="center">
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_two_xw" id="assessment_name_two_xw" value="" /></td>
                        <td align="center"><input type="text" name="score_two_xw" id="score_two_xw" value="" /></td>
                        <td width="200px" align="center">
                    ...
                    <tr>
                        <td height="50px" width="100px" align="center"><input type="text" name="assessment_name_three_xw" id="assessment_name_three_xw" value="" /></td>
                        <td align="center"><input type="text" name="score_three_xw" id="score_three_xw" value="" /></td>
                        <td width="200px" align="center">

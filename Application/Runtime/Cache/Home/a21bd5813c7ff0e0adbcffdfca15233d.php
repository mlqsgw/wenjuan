...
<body>
    ...
    <div class="tools">
    	<ul class="toolbar">
            <li class="click" ><a href="<?php echo u('yjkh_add');?>"><span><img src="/wenjuan/Public/images/t01.png" /></span>考核模板添加</a></li>
        </ul>
    </div>
    <table class="tablelist">
        ...
        <td><a href="#" class="yjkh_details" yjkh_id = <?php echo ($vo["id"]); ?>>详情</a>|<a href="#" class="yjkh_edit" yjkh_edit_id = <?php echo ($vo["id"]); ?>>编辑</a>|<a href="#" class="yjkh_del" yjkh_del_id = <?php echo ($vo["id"]); ?>>删除</a></td>

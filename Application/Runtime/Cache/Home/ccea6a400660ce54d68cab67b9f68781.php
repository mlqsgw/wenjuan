...
<!-- <script language="JavaScript" src="/wenjuan/Public/js/jquery.min.js"></script> -->
<script src="/wenjuan/Public/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(/wenjuan/Public/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <div class="loginbm">万元福考核管理后台</div>
